...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="#">
			...
			<input type="text" placeholder="Police Station Name" name="pstation" title="Please enter the police station name "required/>
			<input type="text" placeholder="Contact no" name="contactno"  pattern=[7-9]{1}[0-9]{9} required title="Please enter the valid contact no "required/>
...
<script src="policelog.js"></script>
...
if(request.getParameter("signup")!=null)
{
	...
	//	String reg_name = sc.nextLine();
		...
		String query="insert into register1 values('"+name+"','"+email+"','"+password+"','"+pstation+"','"+contactno+"')";
...
if(request.getParameter("signin")!=null)
{
	...
	try
	{
		...
		String Query="select * from register1 where email='"+semail+"' AND password='"+spassword+"' ";
