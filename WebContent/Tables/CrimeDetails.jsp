...
<tr>
<td>Name</td><td><input type="text" placeholder="Enter Complainant's Name" name="name" style="width:170px;"required/></td>
</tr>
<tr>
<td>Email </td><td><input type="text" placeholder="Enter Complainant's Email" name="email" style="width:170px;" required/></td>
</tr>
<tr>
<td>Mobile Number </td><td><input type="text" placeholder="Enter Complainant's Mobile Number"  id="mobilenumber" name="mobilenumber" style="width:170px;" required/>

</td>
</tr>
<tr>
<td> Address </td><td><input type="text" placeholder="Enter Complainant's Address" name="address" style="width:170px;"></td>
</tr>
<tr>
<td>Complain Type</td>
                    <td>
                        <select name="complaintype" style="width:170px;">
...
<tr>
<td>Complain Description</td><td><input type="text" placeholder="Enter Complain Description" name="cdes" style="width:170px;"></td>
</tr>
<tr>
<td>Time of Crime</td><td><input type="time" placeholder="Enter crime time" name="ctime" style="width:170px;"></td>
</tr>
<tr>
<td>Date of Crime</td><td><input type="date" placeholder="Enter Crime date" name="cdate" min="2015-01-01" max="2019-07-21" style="width:170px;"></td>
</tr>
<tr>
<td>Crime Location</td><td><input type="text" placeholder="Enter Crime location" name="cloc" style="width:170px;"></td>
</tr>
<td><td><input type="submit" value="ADD" name="save"> </td></td>
<td><td><input type="submit" value="update" name="update"> </td></td>
<td><td><input type="submit" value="select" name="select"> </td></td>
...
if(request.getParameter("save")!=null)
{
	...
	//	String reg_name = sc.nextLine();
		...
		String query="insert into CrimeDetail2 (complainid, name, email, mobilenumber, address, complaintype, complaindescription, crimetime, crimedate, crimelocation) values('"+complainid+"','"+name+"','"+email+"','"+mobilenumber+"','"+address+"','"+complaintype+"','"+complaindescription+"','"+crimetime+"','"+crimedate+"','"+crimelocation+"')";
...
if(request.getParameter("update")!=null)
{
	...
	try{
	  ...
	  //String reg_name = sc.nextLine();
		...
		String query="update CrimeDetail2 set complainid='"+complainid1+"',name='"+name+"',email='"+email1+"',mobilenumber='"+mobilenumber1+"',address='"+address1+"', complaintype='"+complaintype1+"', complaindescription='"+complaindescription1+"', crimetime='"+crimetime1+"', crimedate='"+crimedate1+"', crimelocation='"+crimelocation1+"'  where complainid='"+complainid+"'";		
		System.out.println(query);
		i=st.executeUpdate(query);
